  ...
  <el-popover
    ...
    <div v-if="popoverContentShow">
      ...
      <div class="popover-content-box">
        ...
        <div class="checked-content">
          <div class="checked-top">
            <span class="title">Đã chọn</span>
            <span
              v-if="!closeUser"
              class="title">Nhân viên ({{ userSelectCount }})</span>
            <span
              v-if="!closeDep"
              class="title">Phòng ban ({{ depSelectCount }})</span>
            <el-button
              type="text"
              class="rt"
              @click="emptyClick">Rỗng</el-button>
          </div>
      ...
      <div class="popover-footer">
        <el-button
          type="primary"
          @click="popoverSubmit">Xác nhận</el-button>
        <el-button @click="popoverVisible = false">Huỷ bỏ</el-button>
      </div>
    </div>
    <div
      slot="reference"
    ...
    getDepList() {
      ...
      depList({ type: 'tree' })
        .then(res => {
          ...
          this.breadcrumbList.push({ label: 'Tất cả', data: this.depShowList })
