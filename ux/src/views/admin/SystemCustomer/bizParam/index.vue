<template>
  <div class="system-customer">
    <div class="title">Thông số cho hoạt động kinh doanh</div>
...
export default {
  ...
  data() {
    return {
      menuList: [
        { label: 'Cách liên lạc', key: 'follow-log-type-set' },
        { label: 'Nhóm kinh doanh', key: 'business-group-set' },
        { label: 'Danh mục sản phẩm', key: 'product-category-set' },
        { label: 'Nhắc nhở hết hạn hợp đồng', key: 'contract-expire-set' },
        { label: 'Số lượng KH tối đa', key: 'own' },
        { label: 'Số lượng KH từ chối tối đa', key: 'lock' }
      ],
