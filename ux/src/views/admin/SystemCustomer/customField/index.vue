    ...
    <div class="customer-content">
      <div
        ...
        <div class="content-title">
          <span>Trường thông tin tùy chỉnh</span>
        </div>
        <div class="table-box">
          <div
            ...
            <div class="table-item-time">{{ item.updateTime == 0 ? '0' : item.updateTime }}Cập nhật</div>
            <div class="table-right-btn">
              <el-button
                style="font-weight: 400;"
                type="text"
                @click="handleCustomField('edit', item, index)">Chỉnh sửa</el-button>
              <el-button
                style="font-weight: 400;"
                type="text"
                @click="handleCustomField('preview', item, index)">Xem trước</el-button>
            </div>
          </div>
        </div>
      </div>
