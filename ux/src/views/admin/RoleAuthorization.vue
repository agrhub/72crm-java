<template>
  <div class="role-authorization">
    <p class="title"> Quyền người dùng </p>
    <div class="role-box">
      <!-- 左边导航 -->
      <div class="nav"
        ...
        <div class="nav-new-btn">
          <el-button size="medium"
                     @click="newRoleBtn"> Tạo quyền mới </el-button>
        </div>
        <!-- 角色列表 -->
      ...
      <el-dialog :title="roleTitle"
        ...
        <label class="label-title">Tên quyền</label>
        <el-input v-model="role.title"
                  class="input-role"></el-input>
        <label class="label-title">Loại quyền</label>
        ...
        <span slot="footer"
          ...
          <el-button @click="newRoleClose">Hủy</el-button>
        </span>
      </el-dialog>
      <!-- 右边内容 -->
      <div class="content-box">
        <el-menu :default-active="activeIndex"
                 ...
                 mode="horizontal"
                 @select="handleSelect">
          <el-menu-item index="1">Quyền người dùng</el-menu-item>
          <el-menu-item index="2"
                        v-if="roleActive && (roleActive.pid != 1 || roleActive.pid == 0)">Quyền</el-menu-item>
        </el-menu>
        ...
        <div class="jurisdiction-box"
          ...
          <div style="position: relative;">
            ...
            <el-button size="medium"
                       ...
                       @click="jurisdictionSubmit"> Lưu </el-button>
          </div>
          <div class="jurisdiction-content">
            <div class="content-left">
              <p class="jurisdiction-title">Quản lý chức năng</p>
            ...
            <div class="content-right">
              <p class="jurisdiction-title">Dành cho</p>
              <div class="data-radio">
                <el-radio-group v-model="radioModel">
                  <el-radio :label="1">Chỉ bạn</el-radio>
                  <el-radio :label="2">Bạn và cấp dưới</el-radio>
                  <el-radio :label="3">Chỉ phòng ban</el-radio>
                  <el-radio :label="4">Phòng ban và các phòng ban liên quan</el-radio>
                  <el-radio :label="5">Tất cả</el-radio>
                </el-radio-group>
              </div>
            </div>
          </div>
