<template>
  <div class="se-container">
    <div class="se-header">Quy trình phê duyệt hoạt động kinh doanh</div>
    <div class="se-body">
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button
              type="text"
              size="small"
              @click="handleClick('change', scope)">{{ scope.row['status'] === 0 ? 'Hủy kích hoạt' : 'Kích hoạt' }}</el-button>
            <el-button
              type="text"
              size="small"
  ...
  methods: {
    ...
    fieldFormatter(row, column) {
      ...
      if (column.property === 'examineType') {
        ...
        return { 1: 'Hợp đồng', 2: 'Thanh toán' }[row[column.property]]
      ...
      if (type === 'edit') {
        ...
        this.$confirm(
          'Bạn có chắc bạn muốn ' +
            (scope.row['status'] === 0 ? 'Hủy kích hoạt' : 'Kích hoạt') +
            ' quy trình phê duyệt?',
          'Thông báo',
          {
            confirmButtonText: 'OK',
