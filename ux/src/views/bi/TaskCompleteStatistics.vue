  ...
  <div
    ...
    <div class="handle-bar">
      ...
      <el-select
        ...
        <el-option
          v-for="item in [{label:'Giá trị hợp đồng', value:1},{label:'Số tiền thanh toán', value:2}]"
          :key="item.value"
          :label="item.label"
          :value="item.value"/>
      </el-select>
      ...
      <el-button
        type="primary"
        @click.native="handleClick('search')">Tìm kiếm</el-button>
    </div>
    <div class="content">
...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      fieldList: [
        { field: 'month', name: 'Thời gian' },
        { field: 'receivables', name: 'Số tiền hợp đồng (đồng)' },
        { field: 'achievement', name: 'Số tiền nhận được (đồng)' },
        { field: 'rate', name: 'Tỷ lệ thành công (%)' }
      ],
  ...
  methods: {
    ...
    refreshTableHeadAndChartInfo() {
      this.fieldList[1].name =
        this.typeSelect == 1 ? 'Giá trị hợp đồng (đồng)' : 'Số tiền nhận được (đồng)'
      this.axisOption.legend.data[0] =
        this.typeSelect == 1 ? 'Giá trị hợp đồng' : 'Số tiền nhận được'
    ...
    initAxis() {
      ...
      var option = {
        ...
        legend: {
          data: ['Số tiền hợp đồng', 'Mục tiêu', 'Tỷ lệ thành công'],
          bottom: '0px',
          itemWidth: 14
        },
        grid: {
