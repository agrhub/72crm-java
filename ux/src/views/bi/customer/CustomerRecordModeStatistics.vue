<template>
  <div
    ...
    <filtrate-handle-view
      ...
      :custom-options="[{name:'Biểu đồ bánh', value: 'pie'},{name:'Biểu đồ cột', value: 'bar'}]"
      class="filtrate-bar"
...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      fieldList: [
        { field: 'category', name: 'Phương pháp theo dõi' },
        { field: 'recordNum', name: 'Số lượng' },
        { field: 'proportion', name: 'Tỉ lệ（%）' }
      ]
    }
  },
  computed: {},
