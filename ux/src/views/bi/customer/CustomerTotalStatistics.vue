...
export default {
  ...
  data() {
    return {
      ...
      axisList: [],
      fieldList: [
        { field: 'realname', name: 'Tên nhân viên' },
        { field: 'customerNum', name: 'Số lượng khách hàng mới' },
        { field: 'dealCustomerNum', name: 'Số lượng của khách hàng' },
        { field: 'dealCustomerRate', name: 'Tỷ lệ giao dịch của khách hàng (%)' },
        { field: 'contractMoney', name: 'Tổng số tiền của hợp đồng' },
        { field: 'receivablesMoney', name: 'Số tiền thanh toán' },
        { field: 'unreceivedMoney', name: 'Số tiền chưa thanh toán' },
        { field: 'completedRate', name: 'Tỷ lệ hoàn thành thanh toán (%)' }
      ]
    }
  },
  computed: {},
  ...
  methods: {
    ...
    initAxis() {
      ...
      this.axisOption = {
        ...
        legend: {
          data: ['Số lượng khách hàng giao dịch', 'Số lượng khách hàng mới'],
          bottom: '0px',
          itemWidth: 14
        },
        grid: {
