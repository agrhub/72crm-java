  ...
  data() {
    return {
      ...
      fieldList: [
        ...
        { field: 'recordCount', name: 'Thời gian theo dõi' },
        { field: 'customerCount', name: 'Số lượt khách hàng theo dõi' }
      ]
    }
  },
  computed: {},
  ...
  methods: {
    ...
    initAxis() {
      ...
      var option = {
        ...
        legend: {
          data: ['Số lượt khách hàng theo dõi', 'Thời gian theo dõi'],
          bottom: '0px',
          itemWidth: 14
        },
        grid: {
        ...
        yAxis: [
          {
            type: 'value',
            name: 'Số lượt khách hàng theo dõi',
            axisTick: {
              alignWithLabel: true,
              lineStyle: { width: 0 }
            },
