...
export default {
  ...
  computed: {
    title() {
      return {
        customer: 'Chu kỳ giao dịch khách hàng của từng nhân viên (tính theo thời gian đặt hàng theo hợp đồng và thời gian tạo khách hàng)',
  ...
  methods: {
    ...
    initAxis() {
      ...
      const option = {
        ...
        legend: {
          data: ['Chu kỳ giao dịch', 'Số lượng khách hàng'],
          bottom: '0px',
          itemWidth: 14
        },
        grid: {
    ...
    getFieldList() {
      return {
        customer: [
          ...
          { field: 'customerNum', name: 'Số lượng khách hàng' }
        ],
        product: [
