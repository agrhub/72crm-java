<template>
  <div
    ...
    <filtrate-handle-view
      ...
      @change="getDataList"/>
    <div class="content">
      <div class="content-title">Xếp hạng khách hàng theo dõi (theo người tạo và thời gian theo dõi)</div>
      <div
...
export default {
  ...
  mounted() {
    this.fieldList = [
      ...
      { field: 'count', name: 'Khách hàng theo dõi (số lượt)' }
    ]
    this.initAxis()
  },
  methods: {
    ...
    initAxis() {
      ...
      this.axisOption.tooltip.formatter = '{b} : {c}số lượt'
      this.axisOption.xAxis[0].name = '（số lượt）'
      this.axisChart.setOption(this.axisOption, true)
    }
  }
}
