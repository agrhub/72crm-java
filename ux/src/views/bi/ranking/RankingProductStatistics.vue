<template>
  <div
    ...
    <filtrate-handle-view
      ...
      @change="getDataList"/>
    <div class="content">
      <div class="content-title">Xếp hạng doanh số bán sản phẩm (theo thống kê sản phẩm liên quan của các hợp đồng đã ký và phê duyệt)</div>
      <div
...
export default {
  ...
  mounted() {
    this.fieldList = [
      ...
      { field: 'count', name: 'Số sản phẩm bán ra' }
    ]
    this.initAxis()
  },
  methods: {
