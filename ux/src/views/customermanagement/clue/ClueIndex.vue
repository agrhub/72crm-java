<template>
  <div>
    <c-r-m-list-head
      :search.sync="search"
      :crm-type="crmType"
      title="Quản lý khác hàng tiềm năng"
      placeholder="Vui lòng nhập tên của khách hàng tiềm năng / điện thoại di động / điện thoại"
      main-title="Khách hàng tiềm năng mới"
