    ...
    <flexbox
      ...
      <flexbox-item
        ...
        <div
          ...
          <flexbox class="mark-header"><img
            class="img-mark"
            src="@/assets/img/jianbao.png" >Báo cáo bán hàng</flexbox>
          <flexbox
            :gutter="0"
            wrap="wrap">
            <flexbox-item
      ...
      <flexbox-item
        ...
        <div
          ...
          <flexbox class="mark-header"><img
            class="img-mark"
            src="@/assets/img/zhibiao.png" >Hiệu suất bán hàng</flexbox>
          ...
          <flexbox
            ...
            <div class="target-item">
              <div class="name">Mục tiêu</div>
              <div class="value">{{ gaugeData.achievementMoneys }} đồng</div>
            </div>
            <div class="target-item">
              <div class="name">Giá trị hợp đồng</div>
              <div class="value">{{ gaugeData.contractMoneys }} đồng</div>
            </div>
            <div class="target-item">
              <div class="name">Doanh thu</div>
              <div class="value">{{ gaugeData.receivablesMoneys }} đồng</div>
            </div>
          </flexbox>
        </div>
      </flexbox-item>
      <flexbox-item
        ...
        <div
          ...
          <flexbox class="mark-header"><img
            class="img-mark"
            src="@/assets/img/loudou.png" >Phễu bán hàng
          </flexbox>
          ...
          <div class="funnel-label">
            <div>Chốt đơn：{{ funnelData.winSingle }} đồng</div>
            <div>Hủy đơn：{{ funnelData.loseSingle }} đồng</div>
          </div>
        </div>
      </flexbox-item>
      <flexbox-item
        ...
        <div
          ...
          <flexbox class="mark-header"><img
            class="img-mark"
            src="@/assets/img/qushi.png" >Dự báo bán hàng</flexbox>
          <flexbox style="position: relative;">
            <div class="trend-target-item">
              <div class="name">Giá trị hợp đồng</div>
              <div class="value">{{ trendData.totlaContractMoney }} đồng</div>
            </div>
            <div class="trend-target-item">
              <div class="name">Doanh thu</div>
              <div class="value">{{ trendData.totlaReceivablesMoney }} đồng</div>
            </div>
          </flexbox>
          <div class="trend-label">
            <flexbox class="label-item">
              ...
              <div class="label-item-name">Giá trị hợp đồng</div>
            </flexbox>
            <flexbox
              class="label-item"
              ...
              <div class="label-item-name">Doanh thu</div>
            </flexbox>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      jianbaoItems: [
        ...
        {
          title: 'Cập nhật cơ hội kinh doanh',
  ...
  computed: {
    /** 简报信息 */
    gaugeOptions() {
      return [{ label: 'Doanh thu', value: 2 }, { label: 'Giá trị hợp đồng', value: 1 }]
    }
  },
  watch: {
    data: function(val) {
  ...
  methods: {
    ...
    reportClick(item) {
      if (item.type) {
        this.reportData.title = `Báo cáo bán hàng-${item.title}`
        this.reportData.placeholder = {
          customer: 'Vui lòng nhập tên khách hàng / điện thoại di động / điện thoại bàn',
          contacts: 'Vui lòng nhập tên liên hệ / điện thoại di động / điện thoại bàn',
          business: 'Vui lòng nhập tên mối quan hệ',
          business_status: 'Vui lòng nhập tên mối quan hệ',
          contract: 'Vui lòng nhập mã hợp đồng',
          receivables: 'Vui lòng nhập doanh thu',
          record: ''
        }[item.type]
        if (item.type == 'record') {
        ...
        series: [
          {
            ...
            data: [{ value: 0, name: 'Tỷ lệ hoàn thành' }],
            axisLine: {
              lineStyle: {
                width: 15,
    ...
    initFunnel() {
      ...
      var option = {
        tooltip: {
          trigger: 'item',
          formatter: '{b} <br/> Dự báo doanh thu: {c} đồng'
        },
        calculable: true,
        grid: {
          left: 0,
    ...
    getTrendAxisInfo() {
      const contractList = []
      const receivablesList = []
      if (this.trendSelectValue == 'tháng') {
        const keys = [
          'Tháng 1',
          'Tháng 2',
          'Tháng 3',
        ...
        const keys = ['Quý I', 'Quý II', 'Quý III', 'Quý IV']
        this.axisOption.xAxis[0].data = keys
        for (const key in keys) {
          const element = this.trendData[keys[key]]
          contractList.push(element.contractMoneys)
