...
export default {
  ...
  data() {
    return {
      ...
      allList: [
        {
          name: 'Các ứng dụng được kích hoạt',
          type: 1,
          status: 1,
          sublist: []
        },
        {
          name: 'Ứng dụng bị tắt',
          type: 1,
          status: 0,
          sublist: []
        },
        {
          name: 'Ứng dụng sắp có',
          type: 2,
          sublist: []
        }
      ],
  ...
  methods: {
    ...
    getConfirmMessage(command, item, result) {
      if (command == 'enable') {
        ...
        const message = {
          oa:
            'Sau khi chức năng "Quản lý công việc" ngừng hoạt động, các mục liên quan đến quản lý kinh doanh và quản lý dự án cũng sẽ ngừng hoạt động. Bạn có chắc chắn muốn hủy kích hoạt không?',
          crm:
            'Sau khi hủy kích hoạt "Quản lý kinh doanh", các mục liên quan đến văn phòng và quản lý dự án cũng sẽ bị hủy kích hoạt. Bạn có chắc chắn muốn hủy kích hoạt không?',
          work:
            'Sau khi hủy kích hoạt "Quản lý dự án", các mục liên quan đến văn phòng và quản lý kinh doanh cũng sẽ bị vô hiệu hóa. Bạn có chắc chắn muốn hủy kích hoạt không?'
        }[item.module]
