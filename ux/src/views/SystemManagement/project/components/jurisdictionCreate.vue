<template>
  <el-dialog
    ...
    <div class="label-input">
      <label class="label-title">Mô tả vài trò</label>
      <el-input
        v-model="remark"
        :rows="2"
        type="textarea"
    ...
    <label class="label-title">Phân cấp</label>
...
export default {
  ...
  methods: {
    ...
    sureClick() {
      if (!this.roleName) {
        this.$message.error('Vui lòng điền vào tên vai trò')
      } else {
        this.loading = true
