...
export default {
  ...
  data() {
    return {
      ...
      headFieldList: [
        { field: 'categoryName', name: 'Tên danh mục', width: '115px' },
        { field: 'productName', name: 'Tên sản phẩm', width: '115px' },
        { field: 'contracNum', name: 'Mã hợp đồng', width: '115px' },
        { field: 'ownerUserName', name: 'Tên người phụ trách', width: '115px' },
        { field: 'customerName', name: 'Tên khách hàng', width: '115px' },
        { field: 'productPrice', name: 'Đơn giá', width: '115px' },
        { field: 'productNum', name: 'Số lượng', width: '115px' },
        { field: 'productSubtotal', name: 'Thành tiền', width: '115px' }
      ],
      list: [],
      //
      spanList: [],
