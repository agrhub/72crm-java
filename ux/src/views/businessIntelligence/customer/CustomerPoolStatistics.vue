...
export default {
  ...
  data() {
    return {
      ...
      axisList: [],
      fieldList: [
        { field: 'realname', name: 'Tên khách hàng' },
        { field: 'deptName', name: 'Phòng ban' },
        { field: 'receiveNum', name: 'Số lượng khách hàng tiếp nhận' },
        { field: 'putInNum', name: 'Số lượng khách hàng đưa vào bể đầu vào' }
      ]
    }
  },
  computed: {},
  ...
  methods: {
    ...
    initAxis() {
      ...
      var option = {
        ...
        legend: {
          data: ['Số lượng khách hàng đưa vào bể đầu vào', 'Số lượng khách hàng tiếp nhận'],
          bottom: '0px',
          itemWidth: 14
        },
        grid: {
        ...
        yAxis: [
          {
            type: 'value',
            name: 'Số lượng khách hàng đưa vào bể đầu vào',
            axisTick: {
              alignWithLabel: true,
              lineStyle: { width: 0 }
            },
          ...
          {
            type: 'value',
            name: 'Số lượng khách hàng tiếp nhận',
            axisTick: {
              alignWithLabel: true,
              lineStyle: { width: 0 }
            },
