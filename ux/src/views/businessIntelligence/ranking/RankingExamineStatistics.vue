<template>
  <div
    ...
    <filtrate-handle-view
      ...
      @change="getDataList"/>
    <div class="content">
      <div class="content-title">Xếp hạng số lượng chuyến công tác (theo người để xuất và thời gian của chuyến công tác)</div>
      <div
...
export default {
  ...
  mounted() {
    this.fieldList = [
      ...
      { field: 'count', name: 'Số lần đi công tác (lần)' }
    ]
    this.initAxis()
  },
  methods: {
    ...
    initAxis() {
      ...
      this.axisOption.tooltip.formatter = '{b} : {c}lần'
      this.axisOption.xAxis[0].name = '（lần）'
      this.axisChart.setOption(this.axisOption, true)
    }
  }
}
