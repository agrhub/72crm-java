<template>
  <div
    ...
    <filtrate-handle-view
      ...
      @change="getDataList"/>
    <div class="content">
      <div class="content-title">Xếp hạng số liên lạc mới (theo người tạo, thời gian tạo)</div>
      <div
...
export default {
  ...
  mounted() {
    this.fieldList = [
      ...
      { field: 'structureName', name: 'Phong ban' },
      { field: 'count', name: 'Số liên hệ mới (lượt)' }
    ]
    this.initAxis()
  },
  methods: {
    ...
    initAxis() {
      ...
      this.axisOption.tooltip.formatter = '{b} : {c}lượt'
      this.axisOption.xAxis[0].name = '（lượt）'
      this.axisChart.setOption(this.axisOption, true)
    }
  }
}
