<template>
  <div
    ...
    <filtrate-handle-view
      ...
      @change="getDataList"/>
    <div class="content">
      <div class="content-title">Xếp hạng các hợp đồng đã ký (theo thời gian ký kết thực tế)</div>
      <div
...
export default {
  ...
  mounted() {
    this.fieldList = [
      { field: 'realname', name: 'Chữ ký' },
      { field: 'structureName', name: 'Phòng ban' },
      { field: 'count', name: 'Số lượng hợp đồng đã ký (cái)' }
    ]
    this.initAxis()
  },
  methods: {
    ...
    initAxis() {
      ...
      this.axisOption.tooltip.formatter = '{b} : {c} cái'
      this.axisOption.xAxis[0].name = '（cái）'
      this.axisChart.setOption(this.axisOption, true)
    }
  }
}
