<template>
  <div>
    <c-r-m-list-head
      ...
      :search.sync="search"
      :crm-type="crmType"
      title="Quản lý khách hàng chính thức"
      placeholder="Vui lòng nhập tên khách hàng / điện thoại di động / điện thoại bàn"
      main-title="Khách hàng mới"
    ...
    <div
      ...
      <el-table
        ...
        <el-table-column
          ...
          :fixed="index==0"
          :prop="item.prop"
          :label="genTableHeader(item.label)"
          :width="150"
        ...
        <!--                         show-overflow-tooltip-->
        <!--                         :resizable='false'-->
        <!--                         label="Ngày tối đa cho một hồ sơ"-->
        <!--                         width="120">-->
        <!--          <template slot-scope="scope">-->
