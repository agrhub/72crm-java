<template>
  <div class="mix-container">
    ...
    <section
      ...
      <div
        class="img-bar"
        @click="deleteAllImg">Xóa tất cả</div>
    </section>
    <section
      v-if="files.length > 0"
      class="file-cont">
    ...
    <section
      ...
      <flexbox class="c-header">
        ...
        <div class="c-name">Người liên hệ</div>
      </flexbox>
      <div class="c-body">
        <flexbox wrap="wrap">
          <flexbox
      ...
      if (files.length) {
        for (let index = 0; index < files.length; index++) {
          ...
          if (
            ...
            this.$message.error('Vui lòng chọn đúng hình ảnh')
            return
          }
        }
