  ...
  <div>
    <flexbox
      ...
      <div
        ...
        @click="showFilterClick">Lọc nâng cao</div>
      <filter-form
...
export default {
  ...
  data() {
    return {
      sceneTypes: [
        { type: 'enter', name: 'Đầu vào' },
        { type: 'out', name: 'Đầu ra' }
      ],
      sceneType: null,
  ...
  methods: {
    ...
    selectionBarClick(type) {
      if (type == 'transfer') {
        ...
        var message = ''
        if (type == 'transform') {
          message = 'Bạn có chắc chắn chuyển đổi những khách hàng tiềm năng này thành khách hàng chính thức không?'
        } else if (type == 'put_seas') {
          message = 'Bạn có chắc chắn để chuyển đến bể đầu vào?'
        } else if (type == 'delete') {
          message = 'Bạn có chắc chắn muốn xóa dữ liệu này không?'
        } else if (type == 'lock') {
          message = 'Bạn có chắc chắn muốn khóa những khách hàng này không? Sau khi bị khóa, nó sẽ không chuyển đến bể đầu vào.'
        } else if (type == 'unlock') {
          message = 'Bạn có chắc chắn muốn mở khóa những khách hàng này không?'
        } else if (type == 'start') {
          message = 'Bạn có chắc chắn muốn liệt kê những sản phẩm này không?'
        } else if (type == 'disable') {
          message = 'Bạn có chắc chắn muốn xóa các sản phẩm này không?'
        } else if (type == 'get') {
          message = 'Bạn có chắc chắn muốn yêu cầu khách hàng này không?'
        }
        ...
        // 团队操作
        this.teamsTitle = 'Thêm thành viên trong nhóm'
        this.teamsDialogShow = true
      } else if (type == 'delete_user') {
        // 团队操作
        this.teamsTitle = 'Xóa các thành viên trong nhóm'
        this.teamsDialogShow = true
      } else if (type == 'alloc') {
        // 公海分配操作
    ...
    getSelectionHandleItemsInfo() {
      const handleInfos = {
        ...
        transform: {
          name: 'Chuyển đổi thành khách hàng',
          type: 'transform',
        ...
        delete_user: {
          name: 'Xóa các thành viên trong nhóm',
          type: 'delete_user',
    ...
    getDefaultSceneName() {
      if (this.crmType == 'leads') {
        ...
        return 'Khách hàng chính thức'
      } else if (this.crmType == 'contacts') {
        return 'Thông tin liên lạc'
      } else if (this.crmType == 'business') {
        return 'Cơ hội kinh doanh'
      } else if (this.crmType == 'contract') {
        return 'Hợp đồng'
      } else if (this.crmType == 'receivables') {
        return 'Doanh thu'
