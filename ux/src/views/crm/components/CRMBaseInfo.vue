            ...
            <flexbox
              ...
              <div class="b-cell-value">
                <flexbox
                  ...
                  <el-button
                    type="text"
                    @click.native="handleFile('preview', item, index)">Xem trước</el-button>
                  <el-button
                    type="text"
                    @click.native="handleFile('download', file, index)">Tải về</el-button>
                </flexbox>
              </div>
            </flexbox>
          ...
          <flexbox
            ...
            <flexbox-item
              ...
              <flexbox
                class="b-cell-b"
                align="stretch">
                <div class="b-cell-name">Định vị trên bản đồ</div>
                <div
                  class="b-cell-value"
            ...
            <flexbox-item
              ...
              <flexbox
                class="b-cell-b"
                align="stretch">
                <div class="b-cell-name">Khu vực</div>
            ...
            <flexbox-item
              ...
              <flexbox
                class="b-cell-b"
                align="stretch">
                <div class="b-cell-name">Địa chỉ</div>
