  ...
  <div class="fl-c">
    <flexbox class="fl-h">
      ...
      <flexbox class="fl-h-mark">
        ...
        <div class="fl-h-mark-name">Hồ sơ theo dõi</div>
      </flexbox>
      <el-dropdown
        trigger="click"
    ...
    <div class="fl-b">
      ...
      <div
        ...
        <flexbox
          ...
          <el-button
            ...
            @click="downloadFile(file)">Tải về</el-button>
        </flexbox>
      </div>
      <div
      ...
      <div
        ...
        class="fl-b-other">
        <div class="fl-b-other-name">Các địa chỉ liên hệ</div>
        <div>
          <flexbox
      ...
      <div
        ...
        class="fl-b-other">
        <div class="fl-b-other-name">Các cơ hội kinh doanh</div>
        <div>
          <flexbox
