    ...
    <div class="fl-b">
      ...
      <div class="fl-b-des">
        <flexbox class="fl-b-des-item">
          <div class="fl-b-des-item-name">Người tham gia:</div>
        ...
        <flexbox class="fl-b-des-item">
          <div class="fl-b-des-item-name">Thời gian bắt đầu:</div>
          <div>{{ data.startTime }}</div>
        </flexbox>
        <flexbox class="fl-b-des-item">
          <div class="fl-b-des-item-name">Thời gian kết thúc:</div>
          <div>{{ data.endTime }}</div>
        </flexbox>
        <flexbox class="fl-b-des-item">
          <div class="fl-b-des-item-name">Mô tả:</div>
          <div>{{ data.remark }}</div>
        </flexbox>
      </div>
      <!-- 关联业务 -->
      <div
        ...
        <div class="label">Cơ hội kinh doanh liên quan</div>
        <p
        ...
        <p
          ...
          <img
            src="@/assets/img/relevance_business.png"
            alt="">
          Kinh doanh-{{ business.businessName }}
        </p>
        <p
