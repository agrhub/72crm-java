  ...
  <div style="position: relative;">
    <flexbox class="t-section">
      ...
      <el-button
        ...
        type="primary"
        @click.native="handleTypeClick('discard')">Hủy bỏ</el-button>
      <el-button
        v-if="showTransfer"
        class="head-handle-button"
        type="primary"
        @click.native="handleTypeClick('transfer')">Chuyển đổi</el-button>
      <el-button
        v-if="showEdit"
        class="head-handle-button"
        type="primary"
    ...
    handleTypeClick(type) {
      if (type == 'edit') {
        ...
        if (type == 'transform') {
          ...
          message = 'Bạn có chắc chắn muốn khóa những khách hàng này không? Sau khi bị khóa, khách hàng không đi vào bể đầu vào.'
        } else if (type == 'unlock') {
