...
export default {
  ...
  data() {
    return {
      ...
      leftSides: [
        {
          name: 'Liên hệ với khách hàng ngay hôm nay',
          crmType: 'customer',
          infoType: 'todayCustomer',
          num: 0,
          tips: 'Lần theo dõi tiếp theo là khách hàng của ngày hôm nay',
          hidden: false
        },
        {
          name: 'Khách hàng tiềm năng được giao cho bạn',
          crmType: 'leads',
          infoType: 'followLeads',
          num: 0,
          tips: 'Các manh mối không được theo dõi sau khi chuyển',
          hidden: false
        },
        {
          name: 'Khách hàng được giao cho bạn',
          crmType: 'customer',
          infoType: 'followCustomer',
          num: 0,
          tips: 'Những khách hàng không theo dõi sau khi chuyển, thu thập và phân phối sẽ hiển thị khách hàng có trách nhiệm của họ theo mặc định',
          hidden: false
        },
        {
          name: 'Khách hàng chờ sản lọc',
          crmType: 'customer',
        ...
        },
        {
          ...
          num: 0,
          tips: 'Lời nhắc dựa trên "thời gian hết hạn hợp đồng" và bộ "lời nhắc trước ngày"',
          hidden: false
        }
      ]
    }
