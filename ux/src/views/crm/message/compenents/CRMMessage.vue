    ...
    <div class="option-bar">
      <div v-if="selectionList.length == 0">
        ...
        <div
          ...
          <span class="filtrate-button-title">Lọc</span>
        </div>
        <filter-form
...
export default {
  ...
  computed: {
    ...
    options() {
      if (this.infoType == 'todayCustomer') {
        ...
        return [{ name: 'Được theo dõi', value: 1 }, { name: 'Theo dõi', value: 2 }]
      } else if (
  ...
  methods: {
    ...
    selectionBarClick(type) {
      if (type == 'follow') {
        this.$confirm('Xác nhận thực hiện?', 'Thông báo', {
