  ...
  <div>
    ...
    <div
      ...
      <div class="p-contianer">
        ...
        <span class="money-bar">Tổng số tiền của hợp đồng：{{ moneyPageData.contractMoney || 0 }} / Số tiền đã thanh toán：{{ moneyPageData.receivedMoney || 0 }}</span>
      </div>
    </div>
    <!-- 相关详情页面 -->
    <c-r-m-all-detail
