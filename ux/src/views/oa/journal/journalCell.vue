  ...
  <div
    ...
    <div class="list-content">
        ...
        <div class="row">
          <p class="row-title">
            ...
            <span
              ...
              class="read">{{ data.isRead == 0 ? 'Chưa đọc' : 'Đã đọc' }}</span>
          </p>
          ...
          <el-tooltip
            ...
            <p
              ...
              <span v-if="data.sendDeptList">{{ data.sendDeptList.length }} Phòng ban, </span>
              <span v-if="data.sendUserList">{{ data.sendUserList.length }} Nhân viên</span>
            </p>
          </el-tooltip>
        </div>
        <div
          ...
          <el-dropdown
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                ...
                command="edit">Chỉnh sửa</el-dropdown-item>
              <el-dropdown-item
                v-if="data.permission.isDelete"
                command="delete">Xóa</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
      </div>
      <div class="text">
        <p
          v-if="data.content"
          class="row">
        <span class="title">{{ data.categoryId == 1 ? "Nội dung công việc hôm nay" : data.categoryId == 2 ? "Làm việc trong tuần này" : "Làm việc trong tháng này" }}：</span>{{ data.content }}</p>
        <p
          v-if="data.tomorrow"
          class="row">
        <span class="title">{{ data.categoryId == 1 ? "Nội dung công việc ngày mai" : data.categoryId == 2 ? "Nội dung công việc tuần sau" : "Nội dung công việc tháng sau" }}：</span>{{ data.tomorrow }}</p>
        <p
          v-if="data.question"
          class="row">
        <span class="title">Những vấn đề bắt gặp:</span>{{ data.question }}</p>
      </div>
      <div class="accessory">
        <div
    ...
    <div class="footer">
      <el-button
        ...
        @click="commentBtn(data)">Trả lời</el-button>
      ...
      <div class="btn-group">
        ...
        <div class="btn-box">
          <el-button
            :loading="contentLoading"
            type="primary"
            @click="commentSubmit()">Lưu</el-button>
          <el-button @click="data.showComment = false">Hủy bỏ</el-button>
        </div>
      </div>
    </div>
  </div>
