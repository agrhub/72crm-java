            ...
            <flexbox
              ...
              <div class="b-cell-value">
                <flexbox
                  ...
                  <el-button
                    type="text"
                    @click.native="handleFile('preview', item.value, index)">Xem trước</el-button>
                  <el-button
                    type="text"
                    @click.native="handleFile('download', file, index)">Tải</el-button>
                </flexbox>
              </div>
            </flexbox>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <flexbox justify="center">
                  <el-button
                    type="text"
                    @click.native="handleFile('preview', scope.row.img, 0)">{{ scope.row.img.length }} hóa đơn</el-button>
                </flexbox>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  data() {
    return {
      ...
      travelList: [],
      travelField: [
        { prop: 'vehicle', label: 'Phương tiện' },
        { prop: 'trip', label: 'Công tác' },
        { prop: 'startAddress', label: 'Điểm đi' },
        { prop: 'endAddress', label: 'Điểm đến' },
        { prop: 'startTime', label: 'Ngày đi' },
        { prop: 'endTime', label: 'Ngày về' },
        { prop: 'duration', label: 'Thời gian (ngày)' },
        { prop: 'description', label: 'Mo tả lý do' }
      ],
      expensesField: [
        { prop: 'startAddress', label: 'Điểm đi' },
        { prop: 'endAddress', label: 'Điểm đến' },
        { prop: 'startTime', label: 'Ngày đi' },
        { prop: 'endTime', label: 'Ngày về' },
        { prop: 'traffic', label: 'Đi lại (đồng)' },
        { prop: 'stay', label: 'Ở (đồng)' },
        { prop: 'diet', label: 'Ăn (đồng)' },
        { prop: 'other', label: 'Khác (đồng)' },
        { prop: 'description', label: 'Mô tả lý do' }
      ],
