  ...
  <transition name="slide-fade">
    <el-card
                ...
                <div
                  ...
                  <div class="btn-box">
                    <el-button
                      type="primary"
                      size="mini"
                      @click="nameVShow(taskDataName)">Ẩn</el-button>
                    <el-button
                      size="mini"
                      @click="nameVinput = false">Hủy</el-button>
                  </div>
                </div>
              </div>
          ...
          <div class="footer-title">
            ...
            <span @click="footerTitle(1)">
              ...
              <span
                ...
                @click="footerTitle(isComment)">Nhật ký</span>
            </span>
          </div>
          <div
                  ...
                  <div
                    ...
                    <div class="btn-group">
                      ...
                      <el-button
                        type="primary"
                        class="rt"
                        @click="commentsSub">Lưu</el-button>
                    </div>
                  </div>
                  <div
                    v-else
                    class="footer-bg"
                    @click="addComments = true">Thêm bình luận</div>
      ...
      <div
        ...
        class="tip">
        <span>{{ taskData.createUser.realname }} đăng ngày {{ taskData.createTime }}</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    // 更多 ———— 删除和规定按钮
    moreDelete() {
      this.$confirm('Xác nhận xóa vĩnh viễn?', 'Thông báo', {
    ...
    subtasksCheckbox(val, e) {
      ...
      editTask({
        ...
        .then(res => {})
        .catch(() => {
          this.$message.error('Đánh dấu công việc con không thành công')
          if (e) {
            this.$set(val, 'checked', false)
            this.subTaskProgress--
          } else {
