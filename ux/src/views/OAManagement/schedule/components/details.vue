    ...
    <el-dialog
      ...
      <span
        ...
        <el-button
          ...
          type="danger"
          @click="deleteClose">Xóa</el-button>
      </span>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      list: [
        { label: 'Thời gian bắt đầu', value: 'startTime', type: 'time' },
        { label: 'Thời gian kết thúc', value: 'endTime', type: 'time' },
        { label: 'Người tham dự', value: 'ownerList', type: 'ownerList' },
        { label: 'Họ và tên', value: 'realname', type: 'createUser' },
        { label: 'Ngày tạo', value: 'createTime', type: 'createTime' },
        { label: 'Mô tả', value: 'remark', type: 'bz' }
      ],
      allData: {},
      // 相关详情的查看
      relatedID: '',
  ...
  created() {
    ...
    switch (newVal.remindtype) {
      case 0:
        newVal.remindtypeText = 'Không nhắc'
        break
      case 1:
        newVal.remindtypeText = 'Nhắc nhở đúng giờ'
        break
      case 2:
        newVal.remindtypeText = 'Nhắc trước 5 phút'
        break
      case 3:
        newVal.remindtypeText = 'Nhắc trước 15 phút'
        break
      case 4:
        newVal.remindtypeText = 'Nhắc trước 30 phút'
        break
      case 5:
        newVal.remindtypeText = 'Nhắc trước 1 giờ'
        break
      case 6:
        newVal.remindtypeText = 'Nhắc trước 2 giờ'
        break
      case 7:
        newVal.remindtypeText = 'Nhắc trước 1 ngày'
        break
      case 8:
        newVal.remindtypeText = 'Nhắc trước 2 ngày'
        break
      case 9:
        newVal.remindtypeText = 'Nhắc trước 1 tuần'
        break
    }
  },
  methods: {
