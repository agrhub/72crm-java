  ...
  <div>
    <div
      ...
      <flexbox class="expense-item-head">
        <div class="expense-item-head-title">Yêu cầu thanh toán（{{ index+1 }}）</div>
        <i
          v-if="index != 0"
      ...
      <div class="description">
        <div class="description-title">Mô tả lý do</div>
        <el-input
    ...
    <div class="handle-bar">
      <el-button
        ...
        type="text"
        icon="el-icon-plus"
        @click="addItems(index)">Gởi</el-button>
  ...
  data() {
    return {
      ...
      showItems: [
        ...
        {
          field: 'traffic',
          name: 'Chi phí vận chuyển (đồng)',
          formType: 'text'
        },
        {
          field: 'stay',
          name: 'Phí khách sạn (đồng)',
          formType: 'text'
        },
        {
          field: 'diet',
          name: 'Phí ăn uống（đồng）',
          formType: 'text'
        },
        {
          field: 'other',
          name: 'Các chi phí khác (đồng)',
          formType: 'text'
        }
      ]
    }
