            ...
            <div class="project-list-popover-btn-list">
              <members-dep
                ...
                <p
                  ...
                  slot="membersDep"
                  @click="projectHandleShow = false">Thêm thành viên dự án</p>
              </members-dep>
              ...
              <p
                v-if="canUpdateWork"
                @click="archiveProject">Lưu</p>
              <p
                v-if="canUpdateWork"
                @click="deleteProject">Xóa</p>
              <p v-if="projectData.isOpen == 0" @click="exitProject">Đóng</p>
            </div>
            <img
              slot="reference"
...
export default {
  ...
  methods: {
    ...
    deleteProject() {
      this.$confirm(
        'Bạn có chắc chắn muốn xóa dự án không? Sau khi xóa, tất cả các nhiệm vụ trong dự án này sẽ bị xóa hoàn toàn và không thể khôi phục',
        'Thông báo',
        {
     ...
     */
    exitProject() {
      this.$confirm('Xác nhận rời khỏi ' + ' "' + this.projectName + '"', 'Thông báo', {
        confirmButtonText: 'OK',
        cancelButtonText: 'Cancel',
        type: 'warning'
      })
     ...
     */
    archiveProject() {
      this.$confirm('Xác nhận hoàn thành ' + ' "' + this.projectName + '"', 'Thông tin', {
        confirmButtonText: 'OK',
        cancelButtonText: 'Cancel',
        type: 'warning'
      })
