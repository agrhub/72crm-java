  ...
  <div class="my-task-dialog">
    <el-dialog
        ...
        <el-form-item
          ...
          <div
            ...
            <el-radio-group
              ...
              fill="red"
              text-color="#FFF">
              <el-radio :label="3">Cao</el-radio>
              <el-radio :label="2">Trung bình</el-radio>
              <el-radio :label="1">Thấp</el-radio>
              <el-radio :label="0">Không quan trọng</el-radio>
            </el-radio-group>
          </div>
          <div
      ...
      <span
        ...
        <el-button
          type="primary"
          @click="dialogVisibleSubmit">Lưu</el-button>
  ...
  data() {
    ...
    return {
      ...
      formList: [
        ...
        { label: 'Người quản lý', field: 'mainUserName', type: 'popover' },
        { label: 'Ngày bắt đầu', field: 'startTime', type: 'time' },
        { label: 'Ngày kết thúc', field: 'stopTime', type: 'time' },
        { label: 'Độ ưu tiên', field: 'priority', type: 'priority' },
        { label: 'Mô tả', field: 'description', type: 'textarea' }
      ],
      // 负责人弹出框
      colleaguesList: [],
      popoverModel: false,
      rules: {
        name: [
          ...
          { max: 50, message: 'Tên công việc có thể dài tối đa 50 ký tự', trigger: 'blur' }
        ],
