    ...
    <draggable
                      ...
                      <div class="content">
                        ...
                        <div class="btn-box">
                          <el-button
                            size="mini"
                            type="primary"
                            @click="renameSubmit(item)">Lưu</el-button>
                          <el-button
                            size="mini"
                            @click="item.renameShow = false">Hủy</el-button>
                        </div>
                      </div>
                    </div>
                    <p
                      slot="reference"
                      @click="renameTaskListClick(item)">Đổi tên</p>
                  </el-popover>
                  <p
                    v-if="canCreateTask"
                    @click="createSubTaskClick(item)">Công việc mới</p>
                  <p
                    v-if="canUpdateTaskClass"
                    @click="archiveTaskListClick(item)">Ẩn các công việc đã hoàn thành</p>
                  <p
                    v-if="canDeleteTaskClass"
                    @click="delectTaskListClick(item, index)">Xóa công việc</p>
                </div>
                <img
                  ref="imgPopoverSlot"
                  slot="reference"
          ...
          <div
            ...
            <div class="btn-box">
              <el-button
                size="mini"
                type="primary"
                @click="addSubTask(item)">Lưu</el-button>
              <el-button
                size="mini"
                @click="createSubTaskClassId = 'hidden'">Hủy bỏ</el-button>
            </div>
          </div>
          <div
      ...
      <div
        ...
        <div
          ...
          <span class="el-icon-plus"/>
          <span>Danh sách công việc mới</span>
        </div>
        <div
          ...
          <div class="button-box">
            <el-button
              size="mini"
              type="primary"
              @click="createTaskListSave">Lưu</el-button>
            <el-button
              size="mini"
              @click="createTaskListShow = false">Đóng</el-button>
          </div>
        </div>
      </div>
    </draggable>
...
export default {
  ...
  methods: {
    ...
    delectTaskListClick(val, index) {
      this.$confirm('Bạn có chắc chắn muốn xóa?', 'Thông tin', {
