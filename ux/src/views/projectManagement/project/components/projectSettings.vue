  ...
  <div class="project-settings">
    <el-popover
        ...
        <div class="content">
          <p class="title-checked">
            <span
              ...
              class="span-item"
              @click="tabType = 'base'">Cài đặt cơ bản</span>
            <span
              v-if="isOpen == 0"
              :style="{color: tabType == 'member' ? '#3E84E9': '#333333'}"
              class="span-item"
              @click="tabType = 'member'">Quản lý thành viên</span>
          </p>
          <!-- 基础设置 -->
          <div
            v-show="tabType == 'base'"
            ...
            <div class="row">
              <span class="label name">Tên dự án</span>
            ...
            <div class="row">
              <span class="label">Màu biểu tượng</span>
              <div class="color-box">
                <span
            ...
            <div class="row">
              <span class="label name">Chế độ</span>
              <div class="color-dynamic">
                <el-select
                  v-model="setIsOpen"
                  placeholder="Chọn">
            ...
            <members-dep
              ...
              <div
                ...
                <img
                  ...
                  alt="">
                <span class="add-title">Thêm thành viên</span>
              </div>
            </members-dep>
      ...
      <p
        slot="reference"
        class="title"
        @click="projectSetting">Thiết lập dự án</p>
    </el-popover>
  </div>
</template>
  ...
  data() {
    return {
      ...
      openOptions: [
        {
          value: 0,
          label: 'Riêng tư: Chỉ những thành viên đã tham gia mới có thể xem mục này'
        },
        {
          value: 1,
          label: 'Công khai: Tất cả các thành viên của công ty đều có thể xem mục này'
        }
      ],
      membersList: [],
      // 角色权限
