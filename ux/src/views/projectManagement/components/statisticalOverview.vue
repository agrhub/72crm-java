<template>
  <create-sections title="Tổng quan về công việc">
    <flexbox class="content">
      <div class="content-progress">
        <radial-progress-bar
          ...
          stop-color="#0067E5"
          class="progress">
          <p class="progress-title">Tỷ lệ hoàn thành</p>
        ...
        <radial-progress-bar
          ...
          stop-color="#FF5D60"
          class="progress">
          <p class="progress-title">Tỷ lệ quá hạn</p>
      ...
      <div
        ...
        <div class="content-user-title">Quản lý dự án</div>
      </div>
    </flexbox>
    <slot/>
  </create-sections>
  ...
  methods: {
    ...
    initBar() {
      ...
      this.barOption = {
        ...
        xAxis: {
          type: 'category',
          data: ['Tổng công việc', 'Chưa hoàn thành', 'Đã hoàn thành', 'Quá hạn', 'Đã xóa'],
          axisTick: {
            alignWithLabel: true,
            lineStyle: { width: 0 }
          },
