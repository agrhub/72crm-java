    ...
    <el-card
            ...
            <el-popover
              ...
              <div class="more-btn-group">
                <p
                  ...
                  @click="moreArchive">Ẩn</p>
                <p
                  v-if="taskData.ishidden != 1"
                  @click="moreDelete">Xóa</p>
              </div>
              <span slot="reference">
      ...
      <div
        ...
        <div
          ...
          <span class="text">Công việc đã được {{ taskData.archiveTime }} đã được ẩn.</span>
          <el-button
            type="primary"
            class="border-radius"
            size="mini"
            @click="activateTask">Hiện lại</el-button>
        </div>
        <!-- 回收站 -->
        <div
          v-if="taskData.ishidden == 1"
          class="particulars-extraContent">
          <span class="text">Nhiệm vụ đã được {{ taskData.hiddenTime }} đã được xóa.</span>
          <el-button
            type="primary"
            class="border-radius"
            size="mini"
            @click="recoverTask">Khôi phục lại</el-button>
          <el-button
            type="text"
            @click="thoroughDeleteTask">Xóa hoàn toàn</el-button>
        </div>
          ...
          <div class="card-content">
                ...
                <div
                  ...
                  <div class="btn-box">
                    <el-button
                      type="primary"
                      size="mini"
                      @click="nameVShow(taskDataName)">Lưu</el-button>
                    <el-button
                      size="mini"
                      @click="nameVinput = false">Đóng</el-button>
                  </div>
                </div>
              </div>
              <div class="card-row-right">
                <flexbox class="text-right">
                  <div class="color-label user-name-label"> Quản lý： </div>
                  <div
            ...
            <div
              ...
              <div class="card-row-right">
                <div class="text-right">
                  <span class="color-label"> Hạn chót： </span>
                  <div class="time-top">
                    <el-date-picker
                      ref="endTime"
            ...
            <div class="add-description">
              <div v-show="!addDescriptionShow">
                ...
                <div
                  ...
                  <span class="color-label">Không có mô tả</span>
                  <el-button
                    type="text"
                    icon="el-icon-plus"
                    @click="addDescriptionShow = true">Thêm mô tả</el-button>
                </div>
              </div>
              <div v-show="addDescriptionShow">
                <el-input
                ...
                <div class="btn-box">
                  <el-button
                    type="primary"
                    size="mini"
                    @click="addDescriptionSubmit">Lưu</el-button>
                  <el-button
                    type="text"
                    size="mini"
                    @click="addDescriptionShow = false">Hủy</el-button>
                </div>
              </div>
            </div>
            ...
            <div class="card-content-row card-content-row-column margin-bottom-30">
              <span class="color-label participant">
                ...
                <span>Nghiệp vụ kinh doanh liên quan</span>
              </span>
              <!-- 关联业务 -->
              <related-business
                :margin-left="'0'"
                  ...
                  <div
                    ...
                    <div class="rt">
                      <flexbox class="rt-box">
                        <div
                          v-if="item.stopTime"
                          class="bg-color task-bg-color">{{ item.stopTime | moment("MM-DD") }} Lọc</div>
                        <div
          ...
          <div class="footer-title">
            <span @click="footerTitle(0)">
              ...
              <span
                ...
                class="cursor-pointer">Bình luận</span>
            </span>
            ...
            <span @click="footerTitle(1)">
              ...
              <span
                ...
                @click="footerTitle(isComment)">Hoạt động</span>
            </span>
          </div>
          <div
                ...
                <div class="comments-con">
                  <div
                    ...
                    <div class="btn-group">
                      ...
                      <el-button
                        type="primary"
                        class="rt"
                        @click="commentsSub">Trả lời bình luận</el-button>
                    </div>
                  </div>
                  <div
                    v-else
                    class="footer-bg"
                    @click="addCommentsClick">Thêm bình luận</div>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div class="rt">
                        <span @click="discussDelete(discussItem, replyList, k)">Xóa</span>
                        <span @click="discussBtn(discussItem, -1)">Trả lời</span>
                      </div>
                      ...
                      <div
                        ...
                        <div
                          ...
                          <div class="rt">
                            <span @click="discussDelete(childDiscussItem, discussItem.childCommentList, k)">Xóa</span>
                            <span @click="discussBtn(discussItem, k)">Trả lời</span>
                          </div>
                          <p class="reply-title">
                            <template>
                              <span>Trả lời</span>
                        ...
                        <div class="btn-group">
                          ...
                          <div class="btn-box">
                            <el-button
                              ...
                              type="primary"
                              @click="childCommentSubmit()">Lưu</el-button>
                            <el-button @click="discussItem.show= false">Hủy</el-button>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div
        ...
        class="tip">
        <span>Được tạo bởi {{ taskData.createUser.realname }} ngày {{ taskData.createTime }}</span>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      // 优先级列表
      particularsList: [
        { id: 3, label: 'Cao', color: '#ED6363' },
        { id: 2, label: 'Trung bình', color: '#FF9668' },
        { id: 1, label: 'Thấp', color: '#8bb5f0' },
        { id: 0, label: 'Không quan trọng', color: '#ccc' }
      ],
      // 是否显示子任务
      addSubtasks: true,
      // 任务名称和编辑切换
  ...
  methods: {
    ...
    moreArchive() {
      this.$confirm('Xác nhận ẩn thông tin?', 'Thông báo', {
        confirmButtonText: 'OK',
        cancelButtonText: 'Cancel',
        type: 'warning',
        customClass: 'is-particulars'
