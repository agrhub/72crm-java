...
public class ErpInterceptor implements Interceptor {
    ...
    public void intercept(Invocation invocation) {
        try {
            ...
            if (adminUser==null) {
                controller.renderJson(R.error(302, "access denied"));
                return;
            }
            ...
            invocation.getController().renderJson(R.error("internal server error"));
            Log.getLog(invocation.getController().getClass()).error("Response error", e);
        } finally {
