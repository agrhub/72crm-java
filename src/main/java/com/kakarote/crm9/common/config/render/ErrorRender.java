...
public class ErrorRender extends Render {
    ...
    private static final String JSON404 = "{\"code\": 404, \"msg\": \"404 Request failed\"}";
    private static final String JSON500 = "{\"code\": 500, \"msg\": \"500 Operation failed\"}";
    private static final String JSON401 = "{\"code\": 401, \"msg\": \"401 Unauthorized\"}";
    private static final String JSON403 = "{\"code\": 403, \"msg\": \"403 Insufficient permissions\"}";
    ...
    private String getErrorHtml() {
        ...
        if (errorCode == 404) {
            ...
            return "<html><head><title>" + errorCode + " Error</title></head><body bgcolor='white'><center><h1>" + errorCode
                    + " Error</h1></center><hr>AGRHUB Software</body></html>";
        }
    }
    ...
    private String getErrorJson() {
        ...
        if (errorCode == 404) {
            ...
            return String.format("{code: %d, msg: '%d operation failed'}", errorCode, errorCode);
        }
    }
