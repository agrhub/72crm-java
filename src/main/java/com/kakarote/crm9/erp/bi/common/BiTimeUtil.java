...
public class BiTimeUtil {
    ...
    public String[] getAddress(){
        return new String[]{"Beijing", "Shanghai", "Tianjin", "Guangdong", "Zhejiang",
                "Hainan", "Fujian", "Hunan", "Hubei", "Chongqing", "Liaoning", "Jilin",
                "Heilongjiang", "Henan", "Hebei", "Shaanxi", "Gansu", "Ningxia", "Tibet",
                "Xinjiang", "Qinghai", "Sichuan", "Guangxi", "Guizhou", "Jiangxi", "Jiangsu",
                "Yunnan", "Inner Mongolia", "Shandong", "Shanxi"};
    }
}
