...
public class AdminUserController extends Controller {
    ...
    public void updateImg(){
        ...
        renderJson(R.error("Failed to modify avatar"));
    }
    public void updatePassword(){
        ...
        if(!BaseUtil.verify(adminUser.getUsername()+oldPass,adminUser.getSalt(),adminUser.getPassword())){
            renderJson(R.error("Incorrect password"));
            return;
        }
    ...
    @NotNullValidate(value = "realname",message = "Name cannot be empty")
    @NotNullValidate(value = "username",message = "Username can not be empty")
    public void updateUser(@Para("")AdminUser adminUser){
        boolean b=adminUserService.updateUser(adminUser);
        renderJson(R.isSuccess(b,"Failed to modify information"));
    }
     ...
     */
    @Permissions("manage:users:userUpdate")
    @NotNullValidate(value = "username",message = "Account cannot be empty")
    @NotNullValidate(value = "password",message = "Password can not be blank")
    @NotNullValidate("id")
