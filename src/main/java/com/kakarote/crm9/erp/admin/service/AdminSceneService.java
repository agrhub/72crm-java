...
public class AdminSceneService{
    ...
    public R queryField(Integer label){
        ...
        if(CrmEnum.CRM_LEADS.getType() == label){
            fieldUtil.add("leads_name", "Lead name", "text", settingArr)
                    .add("telephone", "Telephone", "text", settingArr)
                    .add("mobile", "Mobile", "mobile", settingArr)
                    .add("address", "Address", "text", settingArr)
                    .add("next_time", "Next contact time", "datetime", settingArr)
                    .add("remark", "Remark", "text", settingArr)
                    .add("owner_user_id", "Principal", "user", settingArr)
                    .add("create_user_id", "Creator", "user", settingArr)
                    .add("update_time", "Update time", "datetime", settingArr)
                    .add("create_time", "Creation time", "datetime", settingArr);
        }else if(CrmEnum.CRM_CUSTOMER.getType() == label){
            List<Record> dealStatusList = new ArrayList<>();
            dealStatusList.add(new Record().set("name","Unsold").set("value",0));
            dealStatusList.add(new Record().set("name","Deal done").set("value",1));
            fieldUtil.add("customer_name", "Client's name", "text", settingArr)
                    .add("mobile", "Mobile", "text", settingArr)
                    .add("telephone", "Telephone", "text", settingArr)
                    .add("website", "Website", "text", settingArr)
                    .add("next_time", "Next contact time", "datetime", settingArr)
                    .add("remark", "Remark", "text", settingArr)
                    .add("deal_status", "Transaction status", "dealStatus", dealStatusList)
                    .add("owner_user_id", "Principal", "user", settingArr)
                    .add("create_user_id", "Creator", "user", settingArr)
                    .add("update_time", "Update time", "datetime", settingArr)
                    .add("create_time", "Creation time", "datetime", settingArr)
                    .add("address", "Address", "map_address", settingArr);
        }else if(CrmEnum.CRM_CONTACTS.getType() == label){
            fieldUtil.add("name", "Name", "text", settingArr)
                    .add("customer_name", "Customer name", "customer", settingArr)
                    .add("mobile", "Mobile", "mobile", settingArr)
                    .add("telephone", "Phone", "text", settingArr)
                    .add("email", "Email", "email", settingArr)
                    .add("post", "Title", "text", settingArr)
                    .add("address", "Address", "text", settingArr)
                    .add("next_time", "Next contact time", "datetime", settingArr)
                    .add("remark", "Remarks", "text", settingArr)
                    .add("owner_user_id", "Person in charge", "user", settingArr)
                    .add("create_user_id", "Creator", "user", settingArr)
                    .add("update_time", "Update time", "datetime", settingArr)
                    .add("create_time", "Create time", "datetime", settingArr);
        }else if(CrmEnum.CRM_PRODUCT.getType() == label){
            fieldUtil.add("name", "Product name", "text", settingArr)
                    .add("category_id", "Product category", "category", settingArr)
                    .add("num", "Product code", "text", settingArr)
                    .add("price", "Price", "floatnumber", settingArr)
                    .add("description", "Product description", "text", settingArr)
                    .add("owner_user_id", "Person in charge", "user", settingArr)
                    .add("create_user_id", "Creator", "user", settingArr)
                    .add("update_time", "Update time", "datetime", settingArr)
                    .add("create_time", "Create time", "datetime", settingArr);
        }else if(CrmEnum.CRM_BUSINESS.getType() == label){
            fieldUtil.add("business_name", "Business opportunity name", "text", settingArr)
                    .add("customer_name", "Customer name", "customer", settingArr)
                    .add("type_id", "Business Opportunity Status Group", "business_type", crmBusinessService.queryBusinessStatusOptions("condition"))
                    .add("money", "Opportunity amount", "floatnumber", settingArr)
                    .add("deal_date", "Estimated transaction date", "datetime", settingArr)
                    .add("remark", "Remarks", "text", settingArr)
                    .add("owner_user_id", "Person in charge", "user", settingArr)
                    .add("create_user_id", "Creator", "user", settingArr)
                    .add("update_time", "Update time", "datetime", settingArr)
            ...
            checkList.add(new JSONObject().fluentPut("name", "Through").fluentPut("value", 1));
            ...
            checkList.add(new JSONObject().fluentPut("name", "Not submitted").fluentPut("value", 5));
            checkList.add(new JSONObject().fluentPut("name", "Obsolete").fluentPut("value", 6));
            fieldUtil.add("num", "Contract number", "number", settingArr)
                    .add("name", "Contract name", "text", settingArr)
                    .add("check_status", "Audit status", "checkStatus", checkList)
                    .add("customer_name", "Customer name", "customer", settingArr)
                    .add("business_name", "Business opportunity name", "business", settingArr)
                    .add("order_date", "Order time", "date", settingArr)
                    .add("money", "Contract amount", "floatnumber", settingArr)
                    .add("start_time", "Contract start time", "datetime", settingArr)
                    .add("end_time", "Contract end time", "datetime", settingArr)
                    .add("contacts_name", "Customer contractor", "contacts", settingArr)
                    .add("company_user_id", "Company contractor", "user", settingArr)
                    .add("remark", "Remark", "number", settingArr)
                    .add("product", "Product", "product", settingArr)
                    .add("owner_user_id", "Person in charge", "user", settingArr)
                    .add("create_user_id", "Creator", "user", settingArr)
                    .add("update_time", "Update time", "datetime", settingArr)
                    .add("create_time", "Create time", "datetime", settingArr);
            ...
            checkList.add(new JSONObject().fluentPut("name", "Withdrawn").fluentPut("value", 4));
            checkList.add(new JSONObject().fluentPut("name", "Not submitted").fluentPut("value", 5));
            fieldUtil.add("number", "Receipt Number", "number", settingArr)
                    .add("check_status", "Audit status", "checkStatus", checkList)
                    .add("customer_name", "Customer name", "customer", settingArr)
                    .add("contract_num", "Contract number", "contract", settingArr)
                    .add("return_time", "Return date", "date", settingArr)
                    .add("money", "Return amount", "floatnumber", settingArr)
                    .add("remark", "Remarks", "textarea", settingArr)
                    .add("owner_user_id", "Person in charge", "user", settingArr)
                    .add("create_user_id", "Creator", "user", settingArr)
                    .add("update_time", "Update time", "datetime", settingArr)
                    .add("create_time", "Create time", "datetime", settingArr);
        }else{
            return R.error("The scene label does not meet the requirements!");
        }
    ...
    public R deleteScene(AdminScene adminScene){
        if(1 == AdminScene.dao.findById(adminScene.getSceneId()).getIsSystem()){
            return R.error("System scene cannot be deleted");
        }
    ...
    public R queryScene(Integer type){
        ...
        if(number.equals(0)){
            ...
            if(CrmEnum.CRM_LEADS.getType() == type){
                systemScene.setName("All leads").setData(new JSONObject().fluentPut("is_transform", new JSONObject().fluentPut("name", "is_transform").fluentPut("condition", "is"). fluentPut("value", 0)).toString()).save();
                ...
                systemScene.setSceneId(null).setName("The leads I am responsible for").setData(ownerObject.toString()).save();
                ...
                systemScene.setSceneId(null).setName("Subordinates responsible for leads").setData(subOwnerObject.toString()).save();
                ...
                systemScene.setSceneId(null).setName("Transformed leads").setData(jsonObject.toString()).setBydata("transform").save();
            }else if(CrmEnum.CRM_CUSTOMER.getType() == type){
                systemScene.setName("All customers").save();
                systemScene.setSceneId(null).setName("The customers I am responsible for").setData(ownerObject.toString()).save();
                systemScene.setSceneId(null).setName("Customers responsible for subordinates").setData(subOwnerObject.toString()).save();
                JSONObject jsonObject = new JSONObject();
                ...
                systemScene.setSceneId(null).setName("My participating customers").setData(jsonObject.toString()).save();
            }else if(CrmEnum.CRM_CONTACTS.getType() == type){
                systemScene.setName("All Contacts").save();
                systemScene.setSceneId(null).setName("Contact person I am responsible for").setData(ownerObject.toString()).save();
                systemScene.setSceneId(null).setName("Contact person responsible for subordinates").setData(subOwnerObject.toString()).save();
            }else if(CrmEnum.CRM_PRODUCT.getType() == type){
                /*systemScene.setName("All products").save();
                systemScene.setSceneId(null).setName("Products on the shelves").setData(new JSONObject().fluentPut("Whether to be on or off the shelves", new JSONObject().fluentPut("name", "Whether to be on and off shelves").fluentPut ("condition", "is").fluentPut("value", "on the shelf")).toString()).save();
                JSONObject jsonObject = new JSONObject();
                jsonObject.fluentPut("Whether the shelves are on or off", new JSONObject().fluentPut("name", "Whether the shelves are on or off").fluentPut("condition", "is").fluentPut("value", "Off the shelves") );
                systemScene.setSceneId(null).setName("Removed products").setData(jsonObject.toString()).save();*/

                systemScene.setName("All products").save();
                systemScene.setSceneId(null).setName("Products on shelves").setData(new JSONObject().fluentPut("product_status", new JSONObject().fluentPut("name", "product_status").fluentPut("condition", "is").fluentPut("value", "on_shelve")).toString()).save();
                JSONObject jsonObject = new JSONObject();

                jsonObject.fluentPut("product_status", new JSONObject().fluentPut("name", "product_status").fluentPut("condition", "is").fluentPut("value", "off_shelve"));
                systemScene.setSceneId(null).setName("Discontinued products").setData(jsonObject.toString()).save();
            }else if(CrmEnum.CRM_BUSINESS.getType() == type){
                systemScene.setName("All business opportunities").save();
                systemScene.setSceneId(null).setName("The business opportunity I am responsible for").setData(ownerObject.toString()).save();
                systemScene.setSceneId(null).setName("Business opportunities for which subordinates are responsible").setData(subOwnerObject.toString()).save();
                JSONObject jsonObject = new JSONObject();
                jsonObject.fluentPut("ro_user_id", new JSONObject().fluentPut("name", "ro_user_id").fluentPut("condition", "takePart").fluentPut("value", userId));
                systemScene.setSceneId(null).setName("Business Opportunity I Participate In").setData(jsonObject.toString()).save();
            }else if(CrmEnum.CRM_CONTRACT.getType() == type){
                systemScene.setName("All Contracts").save();
                systemScene.setSceneId(null).setName("The contract I am responsible for").setData(ownerObject.toString()).save();
                systemScene.setSceneId(null).setName("Subordinates responsible for the contract").setData(subOwnerObject.toString()).save();
                JSONObject jsonObject = new JSONObject();
                jsonObject.fluentPut("ro_user_id", new JSONObject().fluentPut("name", "ro_user_id").fluentPut("condition", "takePart").fluentPut("value", userId));
                systemScene.setSceneId(null).setName("The contract I participated in").setData(jsonObject.toString()).save();
            }else if(CrmEnum.CRM_RECEIVABLES.getType() == type){
                systemScene.setName("All payment").save();
                systemScene.setSceneId(null).setName("The payment I am responsible for").setData(ownerObject.toString()).save();
                systemScene.setSceneId(null).setName("Receipt of funds under the responsibility of subordinates").setData(subOwnerObject.toString()).save();
            }
        }
    ...
    public R sceneConfig(AdminScene adminScene){
        ...
        if(null != adminScene.getHideIds()){
            ...
            if(number.getInt("number") > 0){
                return R.error("The system scene cannot be hidden");
            }
    ...
    public R getCrmPageList(BasePageRequest basePageRequest){
        ...
        Log.getLog(this.getClass()).debug("sqlPara: " + sqlPara.toString());
        ...
        if(type == CrmEnum.CRM_BUSINESS.getType()){
            recordPage.forEach(record -> {
                if(record.getInt("is_end") == 1){
                    record.set("status_name", "Win");
                }else if(record.getInt("is_end") == 2){
                    record.set("status_name", "Lose order");
                }else if(record.getInt("is_end") == 3){
                    record.set("status_name", "Invalid");
                }
            });
