...
public class OaExamineCategoryService{
    ...
    public List<Record> queryField(){
        ...
        fieldUtil.getFixedField(fieldList, "title", "Approval content","", "text", settingArr, 1);
        fieldUtil.getFixedField(fieldList, "remark", "Remarks", "","text", settingArr, 1);
    ...
    public List<Record> queryFieldList(){
        ...
        fieldUtil.addListHead(fieldList, "title", "Approval content");
        fieldUtil.addListHead(fieldList, "remark", "Remarks");
