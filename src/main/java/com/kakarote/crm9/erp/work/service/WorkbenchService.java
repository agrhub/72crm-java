...
public class WorkbenchService{
    ...
    public R myTask(Long userId){
        ...
        result.add(new Record().set("title", "Inbox").set("is_top", 0).set("count", 0).set("list", new ArrayList<> ()));
        result.add(new Record().set("title", "Today to do").set("is_top", 1).set("count", 0).set("list", new ArrayList<> ()));
        result.add(new Record().set("title", "Next to do").set("is_top", 2).set("count", 0).set("list", new ArrayList< >()));
        result.add(new Record().set("title", "To do later").set("is_top", 3).set("count", 0).set("list", new ArrayList<> ()));
