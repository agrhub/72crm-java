    ...
    private class ExcelImport implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                e.printStackTrace();
                Log.getLog(getClass()).error("Import data error：",e);
            } finally {
        ...
        private void customerImport() {
            ExcelUtil.readBySax(filePath, 0, (int sheetIndex, int rowIndex, List<Object> rowList) -> {
                ...
                if(num>=10000){
                    rowList.add(0, "Import up to 10,000 data at the same time");
                    ...
                    if (templateErr) {
                        ...
                        try {
                            ...
                            for (Record record : uniqueList) {
                                ...
                                if (i > 0) {
                                    ...
                                    if (customer == null) {
                                        ...
                                        rowList.add(0, "Data is duplicated with multiple unique fields");
                                        errorList.add(rowList);
                                        return;
                                    }
                                }
                            ...
                            if (StrUtil.isNotEmpty(city) && (!areaMap.containsKey(province) || !areaMap.get(province).contains(city))) {
                                rowList.add(0, "The provinces and cities do not meet the requirements, please check");
                                errorList.add(rowList);
                                return;
                            }
                            ...
                            if (customer != null) {
                                ...
                                if (auth) {
                                    rowList.add(0, "No overwrite permission for data");
                                    errorList.add(rowList);
                                    return;
                                }
                            ...
                            Log.getLog(getClass()).error("Import data is abnormal:", ex);
                ...
                if (rowIndex > 1) {
                    if (templateErr) {
                        ...
                        try {
                            ...
                            Log.getLog(getClass()).error("Import data exception:", ex);
                            rowList.add(0, "Import exception");
                            errorList.add(rowList);
                        }
                    }
                ...
                if (rowIndex > 1) {
                    if (templateErr) {
                        ...
                        try {
                            ...
                            if (customer == null) {
                                rowList.add(0, "The customer entered does not exist");
                                errorList.add(rowList);
                                return;
                            }
                ...
                if (rowIndex > 1) {
                    if (templateErr) {
                        ...
                        try {
                            ...
                            if (category == null) {
                                rowList.add(0, "The entered product type does not exist");
                                errorList.add(rowList);
                                return;
                            }
