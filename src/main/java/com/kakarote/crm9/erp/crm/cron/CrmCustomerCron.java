    ...
    public void run() {
        ...
        if (dealDay == null || followupDay == null || type == null ){
            ...
            if (followupDay == null){
                ...
                adminConfig.setDescription("The number of days that the customer’s high seas rules have not been followed up");
                adminConfig.save();
            }
            if (type == null){
                AdminConfig adminConfig = new AdminConfig();
                ...
                adminConfig.setDescription("Client high seas rule setting");
                adminConfig.save();
            }
        }else {
                if (type == 1) {
