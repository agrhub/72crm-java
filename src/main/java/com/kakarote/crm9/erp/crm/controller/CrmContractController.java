...
public class CrmContractController extends Controller {
    ...
    @NotNullValidate(value = "contractId",message = "Contract id cannot be empty")
    ...
    @NotNullValidate(value = "contractIds",message = "Contract id cannot be empty")
     ...
     * 添加跟进记录
     */
    @NotNullValidate(value = "typesId",message = "Contract id cannot be empty")
     ...
     * 修改合同到期提醒设置
     */
    @NotNullValidate(value = "status",message = "status cannot be empty")
    ...
    private void export(List<Record> recordList) {
        try (ExcelWriter writer = ExcelUtil.getWriter()) {
            ...
            writer.addHeaderAlias("check_status","Approval Status\n");
            writer.merge(headList.size() - 1, "Contract information");
            ...
            Log.getLog(getClass()).error("Export contract error：",e);
        }
    }
