...
public class CrmReceivablesController extends Controller {
    ...
    @NotNullValidate(value = "receivablesId",message = "The payment id cannot be empty")
    ...
    @NotNullValidate(value = "receivablesIds",message = "The payment id cannot be empty")
    ...
    private void export(List<Record> recordList) {
        try (ExcelWriter writer = ExcelUtil.getWriter()) {
            ...
            writer.merge(headList.size() - 1, "Payment information");
            ...
            Log.getLog(getClass()).error("Export payment error：",e);
        }
    }
