...
public class CrmContactsController extends Controller {
    ...
    @NotNullValidate(value = "contactsIds", message = "Contact id cannot be empty")
    @NotNullValidate(value = "newOwnerUserId", message = "The new owner cannot be empty")
     ...
     * 添加跟进记录
     */
    @NotNullValidate(value = "typesId", message = "Contact id cannot be empty")
    ...
    private void export(List<Record> recordList){
        try (ExcelWriter writer = ExcelUtil.getWriter()) {
            ...
            writer.merge(headList.size() - 1, "contact information");
            ...
            Log.getLog(getClass()).error("Error exporting contacts：",e);
        }
    }
...
//    }
    ...
    public void downloadExcel() {
        ...
        HSSFSheet sheet = wb.createSheet("Contact import form");
        ...
        font.setFontHeightInPoints((short)16);
        cellStyle.setFont(font);
        titleRow.createCell(0).setCellValue("Contact import template (*) is required");
