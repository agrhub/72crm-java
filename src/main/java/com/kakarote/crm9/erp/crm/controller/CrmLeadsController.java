...
public class CrmLeadsController extends Controller {
    ...
    @NotNullValidate(value = "leadsId",message = "The leadId id cannot be empty")
    ...
    @NotNullValidate(value = "leadsIds",message = "The leadId id cannot be empty")
    ...
    @NotNullValidate(value = "leadsIds",message = "The leadId id cannot be empty")
    @NotNullValidate(value = "newOwnerUserId",message = "The new person in charge id cannot be empty")
     ...
     * 添加跟进记录
     */
    @NotNullValidate(value = "typesId",message = "The clue id cannot be empty")
    ...
    private void export(List<Record> recordList){
        try (ExcelWriter writer = ExcelUtil.getWriter()) {
            ...
            writer.merge(headList.size() - 1, "Lead information");
            ...
            Log.getLog(getClass()).error("Export thread error：",e);
        }
    }
...
//    }
    ...
    public void downloadExcel(){
        ...
        HSSFSheet sheet = wb.createSheet("Lead import table");
        ...
        font.setFontHeightInPoints((short)16);
        cellStyle.setFont(font);
        titleRow.createCell(0).setCellValue("Lead import template (*) is required");
    ...
    public void uploadExcel(){
        ...
        if(ownerUserId==null){
            renderJson(R.error("Please select the person in charge"));
            return;
        }
