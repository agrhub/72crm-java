...
public class CrmProductCategoryService {
    ...
    public R deleteById(Integer id){
        ...
        if (number > 0){
            return R.error("The product category has been associated with products and cannot be deleted！");
        }
        if (catagoryNum > 0 ){
            return R.error("There are other product categories under this category！");
        }
