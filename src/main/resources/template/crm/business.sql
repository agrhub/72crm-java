#namespace("crm.business")
    ...
    #sql ("queryProduct")
        ...
        (select value from `72crm_admin_fieldv` as d where d.batch_id = b.batch_id and d.name = 'product_unit') as 'product_unit',
        (select value from `72crm_admin_fieldv` as d where d.batch_id = b.batch_id and d.name = 'product_status') as 'product_status'
